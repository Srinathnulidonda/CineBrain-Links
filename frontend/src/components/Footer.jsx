            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                    ...
                    <div className="col-span-1 md:col-span-2">
                        ...
                        <p className="text-gray-600 text-sm max-w-md">
                            Create branded short links with powerful analytics. Built for teams and individuals who care about their online presence.
                        </p>
                    </div>
                    ...
                    <div>
                        ...
                        <ul className="space-y-2">
                            <li>
                                <a href="mailto:support@cinbrainlinks.com" className="text-gray-600 hover:text-primary-600 text-sm transition-colors">
                                    Contact
                                </a>
                            </li>
                            <li>
                ...
                <div className="border-t border-gray-200 mt-8 pt-8 flex flex-col sm:flex-row justify-between items-center gap-4">
                    <p className="text-gray-500 text-sm">
                        © {currentYear} CinBrainLinks. All rights reserved.
                    </p>
